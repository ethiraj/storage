...
//
//    private final String TENANT = "test-storage";
//
//    @InjectMocks
...
//    public void delete(){
//        // arrange
//        Mockito.doNothing().when(s3RecordClient).deleteRecord(Mockito.eq(record), Mockito.eq(TENANT));
//        Mockito.when(userAccessService.userHasAccessToRecord(Mockito.anyObject()))
//                .thenReturn(true);
//
//        // act
...
//
//        // assert
//        Mockito.verify(s3RecordClient, Mockito.times(1)).deleteRecord(record, TENANT);
//    }
//
////    @Test
////    public void read(){
////        // arrange
////        Long version = 1L;
////        Mockito.when(s3RecordClient.getRecord(Mockito.eq(record), Mockito.eq(TENANT)))

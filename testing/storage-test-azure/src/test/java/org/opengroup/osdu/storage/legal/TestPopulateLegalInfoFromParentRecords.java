...
public class TestPopulateLegalInfoFromParentRecords extends PopulateLegalInfoFromParentRecordsTests {
	...
	public static void classSetup() throws Exception {
        PopulateLegalInfoFromParentRecordsTests.classSetup(azureTestUtils.getToken());
	}

	@AfterClass
	public static void classTearDown() throws Exception {
        PopulateLegalInfoFromParentRecordsTests.classTearDown(azureTestUtils.getToken());
    }
